  ...
  <div class="pdf-container">
    ...
    <div class="content" style="margin-top: 40px;">
      <table class="table">
        <thead>
          <tr>
            <th colspan="4" class="th custom-header">
    ...
    <div class="content">
      <table class="table">
        <thead>
          <tr>
            <th colspan="6" class="th custom-header">
        ...
        <tbody>
          <tr>
            ...
            <td class="td check-cell">${formData.changeType?.application ? "✓" : ""}</td>
            <td colspan="2" class="td">Application</td>
            <td class="td check-cell">${formData.changeType?.database ? "✓" : ""}</td>
            <td colspan="2" class="td">Database</td>
          </tr>
          <tr>
            <td class="td check-cell">${formData.changeType?.hardware ? "✓" : ""}</td>
            <td colspan="2" class="td">Hardware</td>
            <td class="td check-cell">${formData.changeType?.procedures ? "✓" : ""}</td>
            <td colspan="2" class="td">Procedures</td>
          </tr>
          <tr>
            <td class="td check-cell">${formData.changeType?.network ? "✓" : ""}</td>
            <td colspan="2" class="td">Network</td>
            <td class="td check-cell">${formData.changeType?.security ? "✓" : ""}</td>
            <td colspan="2" class="td">Security</td>
          </tr>
          <tr>
            <td class="td check-cell">${formData.changeType?.operatingSystem ? "✓" : ""}</td>
            <td colspan="2" class="td">Operating System/Utilities</td>
            <td class="td check-cell">${formData.changeType?.schedule ? "✓" : ""}</td>
            <td colspan="2" class="td">Schedule</td>
          </tr>
          <tr>
            <th rowspan="4" class="th" style="text-align: center; vertical-align: middle;">Change Priority</th>
            <td class="td check-cell">${formData.changePriority?.urgent ? "✓" : ""}</td>
            <td class="td">Urgent</td>
            <th rowspan="4" class="th" style="text-align: center; vertical-align: middle;">Change Impact</th>
            <td class="td check-cell">${formData.changeImpact?.minor ? "✓" : ""}</td>
            <td class="td">Minor</td>
          </tr>
          <tr>
            <td class="td check-cell">${formData.changePriority?.high ? "✓" : ""}</td>
            <td class="td">High</td>
            <td class="td check-cell">${formData.changeImpact?.medium ? "✓" : ""}</td>
            <td class="td">Medium</td>
          </tr>
          <tr>
            <td class="td check-cell">${formData.changePriority?.medium ? "✓" : ""}</td>
            <td class="td">Medium</td>
            <td class="td check-cell">${formData.changeImpact?.major ? "✓" : ""}</td>
            <td class="td">Major</td>
          </tr>
          <tr>
            <td class="td check-cell">${formData.changePriority?.low ? "✓" : ""}</td>
            <td class="td">Low</td>
            <td class="td"></td>
            <td class="td"></td>
          </tr>
    ...
    <div class="content">
      <table class="table">
        <thead>
          <tr>
            <th colspan="5" class="th custom-header">Change Approval or Rejection</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <th class="th wide-cell">Change Request Status</th>
            <td class="td check-cell">${formData.changeRequestStatus?.accepted ? "✓" : ""}</td>
            <td class="td">Accepted</td>
            <td class="td check-cell">${formData.changeRequestStatus?.rejected ? "✓" : ""}</td>
    ...
    <div class="content" style="margin-top: 300px;">
      <table class="table">
        <thead>
          <tr>
            <th colspan="4" class="th custom-header">Change Implementation Details</th>
          </tr>
        </thead>
        <tbody>
          <tr>
    ...
    <div class="content">
      <table class="table">
        <thead>
          <tr>
            <th colspan="4" class="th custom-header">Change Implementation</th>
          </tr>
        </thead>
        <tbody>
          <tr>
